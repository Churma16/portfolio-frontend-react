                        ...
                        <div className="gradient-border-inner">
                            ...
                            <div className="text-center mb-10">
                                <div className="flex justify-center mb-4">
                                    <div className="p-3 bg-primary/20 rounded-xl border border-primary/50">
                                ...
                                <p className="text-accent/80 text-lg max-w-md mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-3">
                                    <label
                                        className="text-sm font-bold uppercase tracking-widest text-accent/60 flex items-center gap-2">
                                    ...
                                    <div className="relative group">
                                        <textarea
                                            ...
                                            className="token-input-glow w-full h-32 rounded-xl p-4 bg-background/50 border border-border text-accent placeholder:text-accent/30 font-mono text-sm outline-none resize-none focus:border-primary"
                                        />
                                        {token && (
                                            <button
                                                type="button"
                                                onClick={copyToClipboard}
                                                className="absolute top-3 right-3 p-2 rounded-lg bg-lara-border/50 hover:bg-primary/20 transition-colors"
                                                title="Copy token"
                                            >
                                                {copied ? (
                                                    <HiCheck className="w-5 h-5 text-cat-testing" />
                                                ) : (
                                                    <HiOutlineKey className="w-5 h-5 text-accent/60"/>
                                                )}
                                            </button>
                                        )}
                                    </div>
                                ...
                                <div className="flex gap-3 pt-4">
                                    <button
                                        ...
                                        className="flex-1 py-4 px-6 rounded-xl font-bold text-foreground bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 group"
                                    >
                                    ...
                                    {token && (
                                        <button
                                            ...
                                            className="px-6 py-4 rounded-xl font-bold text-foreground bg-cat-framework/30 hover:bg-cat-framework/50 transition-colors border border-cat-framework/30 hover:border-cat-framework/50 flex items-center justify-center gap-2"
                                            title="Clear token"
                                        >
                                ...
                                <button
                                    type="button"
                                    onClick={() => navigate("/")}
                                    className="w-full py-3 rounded-xl font-bold text-accent/70 bg-lara-border/20 hover:bg-lara-border/40 transition-colors border border-border/40 hover:border-border/70 flex items-center justify-center gap-2 group"
                                >
